...
var EmployeeComponent = /** @class */ (function () {
    function EmployeeComponent(empService, activeRoute, posService) {
    ...
    EmployeeComponent.prototype.ngOnInit = function () {
        ...
        this.paramSubscription = this.activeRoute.params.subscribe(function (params) {
            ...
            _this.getPositionSubscription = _this.posService.getPositions().subscribe(function (pos) {
                _this.positions = pos;
            });
        });
    };
...
var PositionComponent = /** @class */ (function () {
    function PositionComponent(posService, activeRoute) {
        this.posService = posService;
        this.activeRoute = activeRoute;
        this.successMessage = false;
        this.failMessage = false;
...
var PositionsComponent = /** @class */ (function () {
    ...
    PositionsComponent.prototype.ngOnInit = function () {
        ...
        this.getPositionSub = this.positionService.getPositions()
            .subscribe(function (positions) { return _this.positions = positions; }, function (e) {
            this.loadingError = true;
        });
    };
